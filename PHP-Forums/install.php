...
class DBHelper{
  ...
  public function startTables(){
    ...
    $tables = array(
    	...
    	"CREATE TABLE `users` (`id` INT(11) NOT NULL AUTO_INCREMENT,`username` VARCHAR(50) NOT NULL,`password` LONGTEXT NOT NULL,`salt` LONGTEXT NOT NULL,`name` VARCHAR(50) NOT NULL,`email` TEXT NOT NULL,`group` INT(11) NOT NULL,`joined` DATETIME NOT NULL,PRIMARY KEY (`id`)) COLLATE='latin1_swedish_ci' ENGINE=InnoDB",
